...
features <- read.csv(file = "C:/Users/MJAR0016/Desktop/data_green.csv")

#cols.input <- c("Total_video_green_head","Total_video_green_body","Th_lead_green_head", "Th_lead_green_body",
 #               "Pat_lead_green_head", "Pat_lead_green_body")


cols.input <- c("Total_video_green_head","Total_video_green_body")
...
set.seed(71)
rf <-randomForest(Type~.,data=mydata, mtry=best.m, importance=TRUE,ntree=500)
print(rf)
